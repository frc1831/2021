...
public class Robot extends TimedRobot {
  ...
  public void robotInit() {
    ...
    // create left motor
    WPI_TalonFX leftMotor = setupWPI_TalonFX(5, Sides.LEFT, false);

    ArrayList<SpeedController> leftMotors = new ArrayList<SpeedController>();
    leftMotors.add(setupWPI_TalonFX(7, Sides.FOLLOWER, false));
    ...
    WPI_TalonFX rightMotor = setupWPI_TalonFX(6, Sides.RIGHT, true);
    ArrayList<SpeedController> rightMotors = new ArrayList<SpeedController>();
    rightMotors.add(setupWPI_TalonFX(8, Sides.FOLLOWER, true));
